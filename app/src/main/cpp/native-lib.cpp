...
Java_com_example_finalopencvproject_MainActivity_stitchImages(JNIEnv *env, jclass type,jobjectArray paths) {
    jstring jstr;
...
//        cvtColor(mat, mat, CV_RGBA2RGB);
    ...
    detail::BestOf2NearestMatcher *matcher = new detail::BestOf2NearestMatcher(false, 0.3f);
